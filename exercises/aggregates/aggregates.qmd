...
```
I see advanced metrics statistics like efficiency rationg and usage rate for all the NBA players of 2024-25. I don't see a clear organizational system for the players and it doesn't include more basic counting stats like points per game etc. Also, players who were traded have their stats separated by team and the aggregate of their stats each in their own row. 
...
**Answer** I would describe the results as skewed toward two guards surprisingly so. While I know there's an increase in "positionless" NBA teams I would have thought that would a lead to an increase in small and power forwards.
...
To me the most interesting aspect of this data is the evolution of the NBA back court and how the guards function and are classified. Who's classified as a shooting guard and what's leading to the extremely high number of shooting guards overall vs. the high number of ones for average minutes. I think more often than not teams are running a true point guard and true center and then three wings, do all three of those wings get classified as shooting guards? 