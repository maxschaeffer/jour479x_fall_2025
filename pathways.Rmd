...
It is most common to move from a generic assistant coach position to a head coach position. Second most common is a head coach leaving one head coaching job for another, (by choice or not). Any other pathway is quite rare.
...
Being a good recruitor can essentially carry your career in college basketball. If you have the reputation of bringing talent to your school, you have a leg-up regardless of your actual in-game coaching ability. I would like to look into whether people who are given the title of recruiting coordinator are actually the best recruitors, essentially what percentage of the best recruitors have worked as a recruiting coordinator at some point.
...
The most common pathways seem to be about two or three stops, including a combination of assistant coach and head coach. Interestingly the second-most common pathway was the 46 coaches who directly went to a head coaching position from another title that's not in our data. The most common transitions are two stops as an assistants then earning the head coach role or moving from assistant to head coach and back down to assistant.
...
I think there are a lot of good stories within these groups. One I'd be interested in is talking to and researching some collection of the 43 interim head coaches who moved to head coach. How many of them were transitioned at the same school vs. got switched to a new school after a strong interim performance. It feels harder than one would expect to get a full time position after being the interim, so I thinkn distinguishing some of the succesful ones could be fun.
...
The most common previous immediate position is an assistant coach receiving a promotion to head coach. Recruiting experience is a factor, with 25% of the head coaches having some kind of recruiting coordinator job in their background. The most common career pathways are two stops as an assistant, going straight to head coach, or going assistant, head coach and back to assistant. There are a few some nontraditional pathways like the strength coach and a couple directors of operations. 

I'm most interested in my idea regarding the transition from interim to head coach. I often feel like interim head coaches are in a lame duck situation where they will likely be gone at the end of the year, but the school didn't want to clean house mid season. How often could potentially an interim coach have stayed, but they feel a sense of loyalty to move with the fired head coach to a new school? I think theres a lot of angles you can take on the story, and 48 is a big enough sample size that you have a lot to look into. 